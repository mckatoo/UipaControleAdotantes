...
public class LoginGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblStatus.setBounds(10, 190, 330, 20);
        lblStatus.getAccessibleContext().setAccessibleName("lblErro");
        ...
        userIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uipa/assets/user-branco.png"))); // NOI18N
        ...
        userIcon.setBounds(0, 40, 350, 130);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uipa/assets/fundo.png"))); // NOI18N
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        CompletableFuture.runAsync(() -> {
            ...
            while (!future.isDone()) {
                lblStatus.setText("VERIFICANDO CREDÊNCIAIS...");
            }
            try {
            ...
            if (permitido) {
                lblStatus.setText("CREDÊNCIAIS ACEITAS.");
                dispose();
