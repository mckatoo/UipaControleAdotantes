...
import uipa.banco.adotantes.AdotantesDAO;
import uipa.banco.animais.AnimaisBean;
import uipa.banco.animais.AnimaisDAO;
import uipa.gui.renderers.DefaultCellRenderer;
import uipa.uteis.FormataData;
...
public class AnimaisCadastro extends javax.swing.JInternalFrame {
    ...
    public AnimaisCadastro() {
        initComponents();
        limparCampos();
        setFrameIcon(new ImageIcon(this.getClass().getResource("/uipa/assets/cao-24x24.png")));
